const CACHE_NAME = "lagunalive-shell-v4.3";
...
const SHELL_FILES = [
  ...
  "./previsioni.html",
  "./previsioni.css?v=4.3",
  "./osservazioni.js?v=4.3",
  "./previsioni-data.js?v=4.3",
  "./previsioni-render.js?v=4.3",
  // Pagina delle stazioni amatoriali collegata dalla home.
  "./stazioni.html",
  "./stazioni.css?v=4.3",
  "./stazioni.js?v=4.3"
];
